...
export declare const getClusterlintDiagnostics: ({ httpClient, }: IContext) => ({ kubernetes_cluster_id, }: IGetClusterlintDiagnosticsApiRequest) => Promise<Readonly<GetClusterlintDiagnosticsResponse>>;
