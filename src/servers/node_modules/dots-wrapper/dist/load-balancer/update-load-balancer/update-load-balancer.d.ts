...
export declare const updateLoadBalancer: ({ httpClient, }: IContext) => ({ algorithm, droplet_ids, enable_proxy_protocol, forwarding_rules, health_check, load_balancer_id, name, redirect_http_to_https, region, sticky_sessions, tag, vpc_uuid, }: ICustomLoadBalancerPayload) => Promise<Readonly<UpdateLoadBalancerResponse>>;
