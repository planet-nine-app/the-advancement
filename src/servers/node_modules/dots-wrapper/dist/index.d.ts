...
declare const createApiClient: ({ endpoint, requestTimeoutInMs, token, }: modules.common.ICreateApiClientInput) => Readonly<{
    _options: Readonly<{
    ...
    app: Readonly<{
        ...
        createApp: ({ project_id, spec, }: modules.app.ICreateAppApiRequest) => Promise<Readonly<modules.app.CreateAppResponse>>;
        ...
        getActiveDeploymentLogs: ({ app_id, component_name, follow, pod_connection_timeout, type, }: modules.app.IGetActiveDeploymentLogsApiRequest) => Promise<Readonly<modules.app.GetActiveDeploymentLogsResponse>>;
        ...
        listApps: ({ page, per_page, with_projects, }: modules.app.IListAppApiRequest) => Promise<Readonly<modules.app.ListAppsResponse>>;
    ...
    containerRegistry: Readonly<{
        ...
        getDockerCredentials: ({ can_write, expiry_seconds, }: modules.containerRegistry.IGetDockerCredentialsApiRequest) => Promise<Readonly<modules.containerRegistry.GetDockerCredentialsResponse>>;
    ...
    database: Readonly<{
        ...
        createDatabaseClusterUser: ({ database_cluster_id, mysql_settings, settings, user_name, }: modules.database.ICreateDatabaseClusterUserApiRequest) => Promise<Readonly<modules.database.CreateDatabaseClusterUserResponse>>;
        ...
        listDatabaseOptions: () => Promise<Readonly<modules.database.ListDatabaseOptionsResponse>>;
    ...
    droplet: Readonly<{
        ...
        createDroplet: ({ backups, image, ipv6, monitoring, name, private_networking, region, size, ssh_keys, tags, user_data, volumes, vpc_uuid, with_droplet_agent, }: modules.droplet.ICreateDropletApiRequest) => Promise<Readonly<modules.droplet.CreateDropletResponse>>;
        createDroplets: ({ backups, image, ipv6, monitoring, names, private_networking, region, size, ssh_keys, tags, user_data, volumes, vpc_uuid, with_droplet_agent, }: modules.droplet.ICreateDropletsApiRequest) => Promise<Readonly<modules.droplet.CreateDropletsResponse>>;
    ...
    genAi: Readonly<{
        listModels: ({ page, per_page, use_case }?: modules.genAi.IListModelsApiRequest) => Promise<Readonly<modules.genAi.ListModelsResponse>>;
        listRegions: ({ page, per_page }?: {
            page?: number;
            per_page?: number;
        }) => Promise<Readonly<modules.genAi.ListRegionsResponse>>;
        listAgents: ({ page, per_page, only_deployed }?: modules.genAi.IListAgentsApiRequest) => Promise<Readonly<modules.genAi.ListAgentsResponse>>;
        createAgent: (data: modules.genAi.ICreateAgentApiRequest) => Promise<Readonly<modules.genAi.CreateAgentResponse>>;
        getAgent: ({ agent_uuid }: modules.genAi.IGetAgentApiRequest) => Promise<Readonly<modules.genAi.GetAgentResponse>>;
        updateAgent: ({ agent_uuid, ...body }: modules.genAi.IUpdateAgentApiRequest) => Promise<Readonly<modules.genAi.UpdateAgentResponse>>;
        deleteAgent: ({ agent_uuid }: modules.genAi.IDeleteAgentApiRequest) => Promise<Readonly<modules.genAi.DeleteAgentResponse>>;
        updateAgentVisibility: ({ agent_uuid, visibility }: modules.genAi.IUpdateAgentVisibilityApiRequest) => Promise<Readonly<modules.genAi.UpdateAgentVisibilityResponse>>;
        listAgentKeys: ({ agent_uuid, page, per_page }: modules.genAi.IListAgentKeysApiRequest) => Promise<Readonly<modules.genAi.ListAgentKeysResponse>>;
        createAgentKey: ({ agent_uuid, name }: modules.genAi.ICreateAgentKeyApiRequest) => Promise<Readonly<modules.genAi.CreateAgentKeyResponse>>;
        updateAgentKey: ({ agent_uuid, api_key_uuid, name, enabled }: modules.genAi.IUpdateAgentKeyApiRequest) => Promise<Readonly<modules.genAi.UpdateAgentKeyResponse>>;
        deleteAgentKey: ({ agent_uuid, api_key_uuid }: modules.genAi.IDeleteAgentKeyApiRequest) => Promise<Readonly<modules.genAi.DeleteAgentKeyResponse>>;
        regenerateAgentKey: ({ agent_uuid, api_key_uuid }: modules.genAi.IRegenerateAgentKeyApiRequest) => Promise<Readonly<modules.genAi.RegenerateAgentKeyResponse>>;
        listAgentRoutes: ({ agent_uuid, page, per_page }: modules.genAi.IListAgentRoutesApiRequest) => Promise<Readonly<modules.genAi.ListAgentRoutesResponse>>;
        attachAgentRoute: ({ parent_agent_uuid, child_agent_uuid, route }: modules.genAi.IAttachAgentRouteApiRequest) => Promise<Readonly<modules.genAi.AttachAgentRouteResponse>>;
        updateAgentRoute: ({ parent_agent_uuid, child_agent_uuid, updates }: modules.genAi.IUpdateAgentRouteApiRequest) => Promise<Readonly<modules.genAi.UpdateAgentRouteResponse>>;
        detachAgentRoute: ({ parent_agent_uuid, child_agent_uuid }: modules.genAi.IDetachAgentRouteApiRequest) => Promise<Readonly<modules.genAi.DetachAgentRouteResponse>>;
        attachFunctionRoute: ({ agent_uuid, function_route }: modules.genAi.IAttachFunctionRouteApiRequest) => Promise<Readonly<modules.genAi.AttachFunctionRouteResponse>>;
        updateFunctionRoute: ({ agent_uuid, function_route_id, updates }: modules.genAi.IUpdateFunctionRouteApiRequest) => Promise<Readonly<modules.genAi.UpdateFunctionRouteResponse>>;
        detachFunctionRoute: ({ agent_uuid, function_route_id }: modules.genAi.IDetachFunctionRouteApiRequest) => Promise<Readonly<modules.genAi.DetachFunctionRouteResponse>>;
        attachKnowledgeBase: ({ agent_uuid, knowledge_base_uuid }: modules.genAi.IAttachKnowledgeBaseApiRequest) => Promise<Readonly<modules.genAi.AttachKnowledgeBaseResponse>>;
        attachKnowledgeBases: ({ agent_uuid, knowledge_base_uuids }: modules.genAi.IAttachKnowledgeBasesApiRequest) => Promise<Readonly<modules.genAi.AttachKnowledgeBasesResponse>>;
        detachKnowledgeBase: ({ agent_uuid, knowledge_base_uuid }: modules.genAi.IDetachKnowledgeBaseApiRequest) => Promise<Readonly<modules.genAi.DetachKnowledgeBaseResponse>>;
        listAgentVersions: ({ agent_uuid, page, per_page }: modules.genAi.IListAgentVersionsApiRequest) => Promise<Readonly<modules.genAi.ListAgentVersionsResponse>>;
        rollbackAgentVersion: ({ agent_uuid, version_uuid }: modules.genAi.IRollbackAgentVersionApiRequest) => Promise<Readonly<modules.genAi.RollbackAgentVersionResponse>>;
        listOpenAIKeys: ({ page, per_page }?: {
            page?: number;
            per_page?: number;
        }) => Promise<Readonly<modules.genAi.ListOpenAIKeysResponse>>;
        createOpenAIKey: (data: modules.genAi.IGenAiExternalApiKeyCreateRequest) => Promise<Readonly<modules.genAi.CreateOpenAIKeyResponse>>;
        getOpenAIKey: ({ key_uuid }: modules.genAi.IGetOpenAIKeyApiRequest) => Promise<Readonly<modules.genAi.GetOpenAIKeyResponse>>;
        updateOpenAIKey: ({ key_uuid, updates }: modules.genAi.IUpdateOpenAIKeyApiRequest) => Promise<Readonly<modules.genAi.UpdateOpenAIKeyResponse>>;
        deleteOpenAIKey: ({ key_uuid }: modules.genAi.IDeleteOpenAIKeyApiRequest) => Promise<Readonly<modules.genAi.DeleteOpenAIKeyResponse>>;
        listAgentsByOpenAIKey: ({ key_uuid, page, per_page }: modules.genAi.IListAgentsByOpenAIKeyApiRequest) => Promise<Readonly<modules.genAi.ListAgentsByOpenAIKeyResponse>>;
        listAnthropicKeys: ({ page, per_page }?: {
            page?: number;
            per_page?: number;
        }) => Promise<Readonly<modules.genAi.ListAnthropicKeysResponse>>;
        createAnthropicKey: (data: modules.genAi.IGenAiExternalApiKeyCreateRequest) => Promise<Readonly<modules.genAi.CreateAnthropicKeyResponse>>;
        getAnthropicKey: ({ key_uuid }: modules.genAi.IGetAnthropicKeyApiRequest) => Promise<Readonly<modules.genAi.GetAnthropicKeyResponse>>;
        updateAnthropicKey: ({ key_uuid, updates }: modules.genAi.IUpdateAnthropicKeyApiRequest) => Promise<Readonly<modules.genAi.UpdateAnthropicKeyResponse>>;
        deleteAnthropicKey: ({ key_uuid }: modules.genAi.IDeleteAnthropicKeyApiRequest) => Promise<Readonly<modules.genAi.DeleteAnthropicKeyResponse>>;
        listAgentsByAnthropicKey: ({ key_uuid, page, per_page }: modules.genAi.IListAgentsByAnthropicKeyApiRequest) => Promise<Readonly<modules.genAi.ListAgentsByAnthropicKeyResponse>>;
        listKnowledgeBases: (options?: import("./types").IListRequest) => Promise<Readonly<modules.genAi.ListKnowledgeBasesResponse>>;
        createKnowledgeBase: (knowledgeBase: modules.genAi.IGenAiKnowledgeBaseCreateRequest) => Promise<Readonly<modules.genAi.CreateKnowledgeBaseResponse>>;
        getKnowledgeBase: ({ knowledge_base_uuid }: modules.genAi.IGetKnowledgeBaseApiRequest) => Promise<Readonly<modules.genAi.GetKnowledgeBaseResponse>>;
        updateKnowledgeBase: ({ knowledge_base_uuid, updates }: modules.genAi.IUpdateKnowledgeBaseApiRequest) => Promise<Readonly<modules.genAi.UpdateKnowledgeBaseResponse>>;
        deleteKnowledgeBase: ({ knowledge_base_uuid }: modules.genAi.IDeleteKnowledgeBaseApiRequest) => Promise<Readonly<modules.genAi.DeleteKnowledgeBaseResponse>>;
        listKnowledgeBaseDataSources: ({ knowledge_base_uuid, page, per_page }: modules.genAi.IListKnowledgeBaseDataSourcesApiRequest) => Promise<Readonly<modules.genAi.ListKnowledgeBaseDataSourcesResponse>>;
        addKnowledgeBaseDataSource: ({ knowledge_base_uuid, data }: modules.genAi.IAddKnowledgeBaseDataSourceApiRequest) => Promise<Readonly<modules.genAi.AddKnowledgeBaseDataSourceResponse>>;
        deleteKnowledgeBaseDataSource: ({ knowledge_base_uuid, data_source_uuid }: modules.genAi.IDeleteKnowledgeBaseDataSourceApiRequest) => Promise<Readonly<modules.genAi.DeleteKnowledgeBaseDataSourceResponse>>;
        listIndexingJobs: ({ page, per_page }: modules.genAi.IListIndexingJobsApiRequest) => Promise<Readonly<modules.genAi.ListIndexingJobsResponse>>;
        createIndexingJob: (data: modules.genAi.ICreateIndexingJobApiRequest) => Promise<Readonly<modules.genAi.CreateIndexingJobResponse>>;
        listIndexingJobDataSources: ({ indexing_job_uuid }: modules.genAi.IListIndexingJobDataSourcesApiRequest) => Promise<Readonly<modules.genAi.ListIndexingJobDataSourcesResponse>>;
        getIndexingJob: ({ indexing_job_uuid }: modules.genAi.IGetIndexingJobApiRequest) => Promise<Readonly<modules.genAi.GetIndexingJobResponse>>;
        cancelIndexingJob: ({ indexing_job_uuid }: modules.genAi.ICancelIndexingJobApiRequest) => Promise<Readonly<modules.genAi.CancelIndexingJobResponse>>;
    }>;
    image: Readonly<{
    ...
    monitoring: Readonly<{
        getDropletAvailableMemoryMetrics: ({ end, host_id, start, }: modules.monitoring.IGetDropletAvailableMemoryMetricsInput) => Promise<Readonly<modules.monitoring.GetDropletAvailableMemoryMetricsResponse>>;
        getDropletBandwidthMetrics: ({ end, host_id, network_interface, start, traffic_direction, }: modules.monitoring.IGetDropletBandwidthMetricsInput) => Promise<Readonly<modules.monitoring.GetDropletBandwidthMetricsResponse>>;
        getDropletCpuMetrics: ({ end, host_id, start, }: modules.monitoring.IGetDropletCpuMetricsInput) => Promise<Readonly<modules.monitoring.GetDropletCpuMetricsResponse>>;
        getDropletFreeMemoryMetrics: ({ end, host_id, start, }: modules.monitoring.IGetDropletFreeMemoryMetricsInput) => Promise<Readonly<modules.monitoring.GetDropletFreeMemoryMetricsResponse>>;
        getDropletTotalMemoryMetrics: ({ end, host_id, start, }: modules.monitoring.IGetDropletTotalMemoryMetricsInput) => Promise<Readonly<modules.monitoring.GetDropletTotalMemoryMetricsResponse>>;
    }>;
    project: Readonly<{
...
export { createApiClient, modules, };
