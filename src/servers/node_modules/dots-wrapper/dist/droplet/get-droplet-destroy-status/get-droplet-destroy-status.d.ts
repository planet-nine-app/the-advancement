...
export declare const getDropletDestroyStatus: ({ httpClient, }: IContext) => ({ droplet_id, }: IGetDropletDestroyStatusApiRequest) => Promise<Readonly<GetDropletDestroyStatusResponse>>;
